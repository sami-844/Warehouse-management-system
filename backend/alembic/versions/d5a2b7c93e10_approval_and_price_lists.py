...
def upgrade():
    op.execute("ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS approval_status TEXT DEFAULT 'not_required'")
    op.execute("ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS approved_by INTEGER")
    op.execute("ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS approved_at TIMESTAMP")
    op.execute("ALTER TABLE purchase_orders ADD COLUMN IF NOT EXISTS approval_notes TEXT")
    op.execute("""
